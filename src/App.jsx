...
const css = `
  @import url('https://fonts.googleapis.com/css2?family=Cinzel:wght@400;500;600;700&family=Raleway:wght@200;300;400;500&family=Noto+Sans+KR:wght@200;300;400;500&family=Noto+Serif+KR:wght@300;400;500;600&display=swap');
  ...
  * { box-sizing:border-box; margin:0; padding:0; }
  ...
  @keyframes name-in {
    0%   { opacity:0; transform:scale(0.7) translateY(20px); letter-spacing:20px; }
  ...
  .left-logo .yr  { font-family:'Cinzel',serif; font-size:20px; font-weight:400; color:var(--gold-light); letter-spacing:4px; line-height:1; }
  .left-logo .sm  { font-family:'Cinzel',serif; font-size:14px; font-weight:400; color:var(--gold-light); letter-spacing:2px; }
  .left-logo .oc  { font-family:'Cinzel',serif; font-size:32px; font-weight:600; color:var(--gold-light); letter-spacing:5px; line-height:1; margin-bottom:6px; }
  .left-logo .sub {
    display:inline-block;
    font-family:'Noto Serif KR',serif; font-size:10px; font-weight:300;
  ...
  .sec-label {
    font-family:'Raleway',sans-serif; font-size:7px; font-weight:400;
  ...
  .count-info .total { font-family:'Cinzel',serif; font-size:11px; color:var(--gold-dim); letter-spacing:1px; }
  .count-info .total span { font-size:18px; color:var(--gold-light); margin:0 4px; }

  .draw-count-row { display:flex; align-items:center; gap:8px; margin-top:12px; }
  .dc-label { font-family:'Raleway',sans-serif; font-size:9px; font-weight:300; letter-spacing:3px; color:var(--gold-dim); }
  ...
  .draw-btn {
    ...
    letter-spacing:6px; text-transform:uppercase; color:var(--gold-light);
  ...
  .standby .ornament { font-family:'Cinzel',serif; font-size:2vw; color:rgba(212,168,64,0.2); letter-spacing:8px; margin-bottom:24px; }
  .standby .big-title {
    font-family:'Cinzel',serif; font-size:5.5vw; font-weight:600; letter-spacing:0.15em; line-height:1; margin-bottom:16px;
    background:linear-gradient(135deg,#f0d080,#d4a840,#b8922e,#d4a840,#f0d080);
    background-size:300% auto;
    -webkit-background-clip:text; background-clip:text; color:transparent;
    animation:shimmer 4s linear infinite;
  }
  .standby .big-sub { font-family:'Noto Serif KR',serif; font-size:1.4vw; font-weight:300; color:var(--cream); letter-spacing:8px; margin-bottom:32px; }
  .standby .hint { font-family:'Raleway',sans-serif; font-size:0.8vw; font-weight:300; letter-spacing:4px; color:var(--gold-dim); text-transform:uppercase; }

  .drawing-screen { text-align:center; animation:fadeIn 0.4s ease both; }
  .drawing-screen .label { font-family:'Raleway',sans-serif; font-size:0.9vw; font-weight:300; letter-spacing:8px; text-transform:uppercase; color:var(--gold); margin-bottom:20px; }
  .slot-display { font-family:'Noto Serif KR',serif; font-size:5vw; font-weight:500; color:rgba(255,255,255,0.15); letter-spacing:8px; animation:slot-spin 0.15s linear infinite; min-height:1.2em; }

  .winner-screen { text-align:center; width:100%; animation:winner-in 0.7s cubic-bezier(0.34,1.4,0.64,1) both; }
  .winner-screen .w-label { font-family:'Raleway',sans-serif; font-size:0.9vw; font-weight:300; letter-spacing:10px; text-transform:uppercase; color:var(--gold); margin-bottom:8px; }
  .winner-screen .w-label-ko { font-family:'Noto Serif KR',serif; font-size:1vw; font-weight:300; letter-spacing:8px; color:var(--gold-dim); margin-bottom:32px; }
  .winner-screen .w-line { width:80px; height:1px; margin:0 auto 32px; background:linear-gradient(90deg,transparent,var(--gold),transparent); }
  .winner-screen .w-name {
    font-family:'Noto Serif KR',serif; font-size:7vw; font-weight:500;
    color:var(--white); letter-spacing:10px; line-height:1; margin-bottom:32px;
    animation:name-in 0.8s cubic-bezier(0.22,1,0.36,1) 0.2s both;
  }
  .winner-screen .w-rank {
    font-family:'Cinzel',serif; font-size:1.1vw; font-weight:400; color:var(--gold); letter-spacing:6px;
    padding:12px 32px; border:1px solid rgba(212,168,64,0.25);
    display:inline-block; margin-bottom:32px;
    animation:rank-in 0.5s ease 0.6s both;
  }
  .next-btn {
    padding:14px 48px; background:none; border:1.5px solid var(--gold); cursor:pointer;
    font-family:'Cinzel',serif; font-size:1vw; font-weight:400;
    letter-spacing:6px; text-transform:uppercase; color:var(--gold-light);
  ...
  .wl-title { font-family:'Raleway',sans-serif; font-size:7px; font-weight:300; letter-spacing:4px; text-transform:uppercase; color:var(--gold-dim); margin-bottom:6px; }
  .wl-item { font-family:'Noto Serif KR',serif; font-size:13px; font-weight:400; color:rgba(245,237,216,0.6); letter-spacing:2px; line-height:1.8; animation:fadeUp 0.3s ease both; }
  .wl-item .wl-rank { font-family:'Cinzel',serif; font-size:10px; color:var(--gold); margin-right:6px; }

  .progress-info { position:absolute; bottom:24px; left:28px; z-index:3; font-family:'Cinzel',serif; font-size:11px; color:var(--gold-dim); letter-spacing:3px; }
  .progress-info span { color:var(--gold-light); font-size:16px; }
    ...
    <div className="stage">
      ...
      <div className="left-panel">
        <div className="left-logo">
          ...
          <span className="sub">OCIO 세미나</span>
